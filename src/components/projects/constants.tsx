export const PROJECTS = [
  ...
  },
  {
    ...
    liveUrl: "https://spotify-clone-9w008xf7z-danielzuhads-projects.vercel.app",
  ...
  },
  {
    name: "Chat App",
    description:
      "The Chat Next App is a real-time chat application built with modern web technologies. It allows users to authenticate securely, send and receive messages in real time, and manage their conversations through an intuitive user interface. The app integrates Pusher for real-time communication and NextAuth for authentication. ",
    gitHubUrl: "https://github.com/danielzuhad/Chat-App-Next",
    liveUrl: "https://chat-app-next-murex.vercel.app/",
